...
namespace StudentPortalMVC.Controllers
{
    public class SemestersController : Controller
    {
        ...
        public SemestersController(StudentPortalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SemesterId,SemesterName,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,Status")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SemesterId,SemesterName,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,Status")] Semester semester)
        {

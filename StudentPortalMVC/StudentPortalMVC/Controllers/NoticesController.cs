...
namespace StudentPortalMVC.Controllers
{
    public class NoticesController : Controller
    {
        ...
        public NoticesController(StudentPortalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NoticeId,Notices,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,Status")] Notice notice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NoticeId,Notices,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,Status")] Notice notice)
        {
